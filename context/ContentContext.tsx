  ...
  team: {
    medical: [
      ...
      },
      {
        ...
        bio: "Especialista em Ortodontia, con formação em Ortodontia Clínica e Alinhadores Spark."
      },
      {
...
export const ContentProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  const [content, setContent] = useState(() => {
    try {
      // Usamos v3 para forzar a los navegadores a limpiar la caché anterior
