...
const Campaigns: React.FC = () => {
  ...
  const trackCampaignClick = () => {
    // Meta Pixel
    if (typeof (window as any).fbq === 'function') {
      (window as any).fbq('track', 'Contact', { content_name: 'Campaign WhatsApp' });
      (window as any).fbq('track', 'ViewContent', { content_type: 'campaign' });
    }
    // Google Ads
    if (typeof (window as any).gtag === 'function') {
      (window as any).gtag('event', 'contact_click', {
        ...
        'event_label': 'WhatsApp Info Button'
      });
    }
  };
