    ...
    <div className="animate-fade-in-up max-w-[1400px] mx-auto px-4 py-12 flex flex-col items-center">
      ...
      <div className="text-center mb-16 flex flex-col items-center">
        ...
        <a 
          ...
          className="inline-flex items-center justify-center gap-3 bg-[#c2a9eb] text-white px-6 py-3 rounded-full text-sm font-bold shadow-lg hover:bg-clinic-blue hover:-translate-y-1 transition-all transform text-center w-auto max-w-[90vw] sm:px-10 sm:py-4 sm:text-xl active:scale-95"
        >
