    ...
    <div className="animate-fade-in-up max-w-[1400px] mx-auto px-4 py-12 flex flex-col items-center">
      ...
      <div className="text-center mb-16">
        <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold text-clinic-blue mb-8 flex flex-wrap justify-center items-center gap-4">
          ...
          <div className="w-[100px] h-[65px] md:w-[120px] md:h-[80px] rounded-xl overflow-hidden border-4 border-white shadow-xl bg-white/10 flex items-center justify-center hover:scale-110 transition-transform">
              <img 
        ...
        <a 
          ...
          target="_blank" 
          rel="noreferrer"
          className="inline-flex items-center justify-center gap-3 bg-[#c2a9eb] text-white px-6 sm:px-10 py-3 sm:py-4 rounded-full text-sm sm:text-xl font-bold shadow-lg hover:bg-clinic-blue hover:-translate-y-1 transition-all transform text-center whitespace-normal"
        >
      ...
      <div className="bg-white/40 p-6 sm:p-10 rounded-3xl border border-white/50 text-center max-w-2xl mb-16">
        ...
        <p className="text-base sm:text-lg text-gray-700">Novas campanhas e promoções especiales serão anunciadas aqui. Siga-nos nas redes sociais para não perder nenhuma oportunidade.</p>
      </div>
