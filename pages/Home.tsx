...
const Home: React.FC = () => {
  ...
  return (
    <div className="animate-fade-in-up">
      ...
      {/* Stories Section - REFINED CONCENTRATED GLOW */}
      <section 
      ...
      >
        {/* Aura pegada al cajón - Reducido el blur para que no se pierda en la distancia */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[160px] md:w-[260px] aspect-[9/16] pointer-events-none opacity-70 z-0">
           <div className="absolute inset-0 rounded-full blur-[45px] animate-glow-cycle"></div>
           <div className="absolute inset-10 rounded-full blur-[35px] animate-glow-cycle opacity-90" style={{ animationDelay: '-2.5s' }}></div>
        </div>
      ...
      {/* Experience Section - CONCENTRATED BORDER AURA */}
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center relative z-10">
          <div className="flex flex-col items-center lg:items-end order-2 lg:order-1 gap-8">
             <div className="relative group/video w-full max-w-[245px] md:max-w-[340px] aspect-[9/16] rounded-[2.8rem] md:rounded-[4.5rem] p-[2px] overflow-visible">
                ...
                {/* Aura concentrada - Reducido blur para que bordee el video y sea apreciable */}
                <div className="absolute -inset-6 md:-inset-10 rounded-full blur-[40px] animate-glow-cycle opacity-80"></div>
                <div className="absolute -inset-3 md:-inset-6 bg-gradient-to-tr from-clinic-blue via-clinic-lime to-clinic-purple rounded-full opacity-60 blur-[25px] animate-pulse"></div>
                
                {/* Accent Orbs - Más nítidos y cercanos */}
                <div className="absolute -top-2 -left-2 w-20 h-20 bg-clinic-lime/40 rounded-full blur-[25px] animate-float" style={{ animationDuration: '6s' }}></div>
                <div className="absolute -bottom-2 -right-2 w-20 h-20 bg-clinic-purple/40 rounded-full blur-[25px] animate-float" style={{ animationDuration: '5s', animationDelay: '1s' }}></div>
