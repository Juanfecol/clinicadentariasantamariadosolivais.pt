...
const Home: React.FC = () => {
  ...
  return (
    <div className="animate-fade-in-up">
      ...
      {/* Stories Section - HIGH INTENSITY CONCENTRATED GLOW */}
      <section 
      ...
      >
        {/* Concentrated aura behind the central story - 50% smaller, 30% stronger */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[250px] md:w-[350px] aspect-[9/16] pointer-events-none opacity-85 z-0">
           <div className="absolute inset-0 rounded-full blur-[50px] animate-glow-cycle"></div>
           <div className="absolute inset-4 rounded-full blur-[40px] animate-glow-cycle opacity-100" style={{ animationDelay: '-2.5s' }}></div>
        </div>
      ...
      {/* Experience Section - ULTIMATE CONCENTRATED BORDER GLOW */}
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center relative z-10">
          <div className="flex flex-col items-center lg:items-end order-2 lg:order-1 gap-8">
             <div className="relative group/video w-full max-w-[245px] md:max-w-[340px] aspect-[9/16] rounded-[2.8rem] md:rounded-[4.5rem] p-[2px] overflow-visible">
                ...
                {/* MAXIMUM CONCENTRATED BORDER GLOW - 50% SMALLER, 30% STRONGER */}
                <div className="absolute -inset-4 md:-inset-8 rounded-full blur-[45px] animate-glow-cycle opacity-100"></div>
                <div className="absolute -inset-2 md:-inset-4 bg-gradient-to-tr from-clinic-blue via-clinic-lime to-clinic-purple rounded-[3.2rem] md:rounded-[5.5rem] opacity-100 blur-[25px] animate-pulse"></div>
                
                {/* Precise Floating Accent Orbs */}
                <div className="absolute -top-6 -left-6 w-24 h-24 bg-clinic-lime/60 rounded-full blur-[30px] animate-float" style={{ animationDuration: '6s' }}></div>
                <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-clinic-purple/60 rounded-full blur-[30px] animate-float" style={{ animationDuration: '5s', animationDelay: '1s' }}></div>
