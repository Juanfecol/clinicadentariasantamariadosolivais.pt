...
const Home: React.FC = () => {
  ...
  return (
    <div className="animate-fade-in-up">
      ...
      {/* Floating Cards Simulation - OPTIMIZED WITH WILL-CHANGE */}
